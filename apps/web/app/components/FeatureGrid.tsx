...
const features = [
    {
        ...
        description:
            "Optimized via MiniSearch for sub-millisecond retrieval times.",
    },
    {
        icon: ShieldCheck,
        title: "Type Safe",
        description:
            "Written in TypeScript with 100% strict mode and Zod validation.",
    },
    {
        icon: Box,
        title: "Zero Bloat",
        description:
            "Core logic is separated from data to keep your bundles small.",
    },
    {
        icon: Database,
        title: "Rich Dataset",
            ...
            <div className="mx-auto max-w-7xl px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                        We rebuilt the classic quotes library from the ground up
                        for the modern JavaScript ecosystem.
                    </p>
                </div>
